...
public class ChatracterAnimationDelegate : MonoBehaviour
{
    ...
    void ActivatePlayer()
    {
        GameObject.FindWithTag(Tags.PLAYER_TAG).GetComponent<PlayerMovement>().enabled = true;
